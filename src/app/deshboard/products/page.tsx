        ...
        <TableBody>
          ...
          return(
            <TableRow key={product._id}>
              <TableCell className="font-medium"><Image src={product.productImage} alt="Image" height={50} width={50}/></TableCell>
